...
class Box {
    ...
    //Constructor used to make a Cube
    Box(double len) {
    ...
    double getvolume() {
        return width * height * depth;
            ...
            /*The following code block defines a class called BoxWeighted that extends the Box class
...
/*
The Shipping class extends the BoxWeighted class and adss a field called cost
