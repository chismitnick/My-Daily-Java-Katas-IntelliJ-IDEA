...
class Cube {
    ...
    //Constructor used to create a OOP.Cube
...
class ConstructorOverload {
    ...
    public static void main(String[] args) {
        ...
        //OOP.Volume of first cube
        vol = cube1.volume();
        System.out.println("\n The volume of OOP.Cube 1 is:" + vol);

        // OOP.Volume of second cube
        vol = cube2.volume();
        System.out.println("\n The volume of OOP.Cube 2 is:" + vol);

        //OOP.Volume of third cube
        vol = cube3.volume();
        System.out.println("\n The volume of OOP.Cube 3 is:" + vol);
    }
