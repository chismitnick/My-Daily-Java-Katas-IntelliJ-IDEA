...
enum Cars {
    ...
    //two restrictions that apply to enumerations are:
    // An enum cannot be a superclass meaning that an enum cannot be extended
    //An enum cannot inherit another class
}
